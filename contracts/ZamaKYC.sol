...
contract ZamaKYC is SepoliaConfig {
    ...
    function submitKYC(
        ...
        FHE.allow(encryptedNationality, msg.sender);
    ...
    function getKYCInfo(
        ...
        view
        kycExists(user)
        returns (string memory identityDocumentHash, string memory name, euint32 nationality, euint32 birthYear)
    {
        KYCInfo storage kyc = kycRecords[user];
        return (kyc.identityDocumentHash, kyc.name, kyc.nationality, kyc.birthYear);
    }
